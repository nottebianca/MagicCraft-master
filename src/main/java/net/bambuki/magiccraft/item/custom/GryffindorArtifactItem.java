...
public class GryffindorArtifactItem extends Item {

    public GryffindorArtifactItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag flag) {
        if(Screen.hasShiftDown()){
            components.add(Component.literal("Place in inventory to get fire resistance.").withStyle(ChatFormatting.GREEN));
        } else {
